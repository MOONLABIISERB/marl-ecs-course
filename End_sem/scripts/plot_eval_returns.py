...
if __name__ == "__main__":
    ...
    eval_agents = ["IQN"]
    colors = ["b", "tab:orange"]
    data_dirs = [r"C:\Users\Pavan\Desktop\Multi_Robot_Distributional_RL_Navigation-main\Results3\IQN\training_2024-11-26-16-16-00"]
    ...
    fig.tight_layout()
    fig.savefig("learning_curvesIQN.png")
