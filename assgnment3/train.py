...
class Agent:
    def __init__(self, num_actions=5, alpha=0.1, gamma=0.99, epsilon=0.1):
        self.q_table = {}
        self.alpha = alpha
        self.gamma = gamma
...
class MARLTrainer:
    def __init__(self, env, num_episodes=1000, max_steps_per_episode=100):
        ...
        self.logs = {agent_id: [] for agent_id, value in self.agents.items()}
        plt.ion()
        ...
        for episode in range(self.num_episodes):
            ...
            for step in range(self.max_steps_per_episode):
                ...
                for agent_id, agent in self.agents.items():
                    ...
                    self.logs[agent_id].append(rewards[agent_id])
